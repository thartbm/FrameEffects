...
def doDotTrial(cfg):
    ...
    cfg['hw']['gray_bar'].pos = [-frameoffset[0],-frameoffset[1]+1]
    ...
    while waiting_for_response:
        ...
        cfg['hw']['gray_bar'].width = percept
        cfg['hw']['gray_bar'].draw()
...
def getStimuli(cfg, setup='tablet'):
    ...
    cfg['hw']['gray_bar'] =  visual.Rect(win=cfg['hw']['win'],
                                           width=6,
                                           height=0.5,
                                           units='deg',
                                           lineColor=None,
...
def getTasks(cfg):
    ...
    if cfg['expno']==1:
        ...
        condictionary = [
                 ...
                 # dot moving frame: 1/3 period only
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotmovingframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotmovingframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotmovingframe'},

                 # dot-window frame: 1/3 period only
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotwindowframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotwindowframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotwindowframe'},

                 # dot-backgroud: 5 speeds!
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotbackground'},
                 {'period':1/1, 'amplitude':4, 'stimtype':'dotbackground'},
                 {'period':1/2, 'amplitude':4, 'stimtype':'dotbackground'},
                 {'period':1/4, 'amplitude':4, 'stimtype':'dotbackground'},
                 {'period':1/5, 'amplitude':4, 'stimtype':'dotbackground'},
                 ...
                 {'period':1/3, 'amplitude':1, 'stimtype':'dotbackground'},
                 {'period':1/3, 'amplitude':2, 'stimtype':'dotbackground'},
                 {'period':1/3, 'amplitude':3, 'stimtype':'dotbackground'},
                 {'period':1/3, 'amplitude':5, 'stimtype':'dotbackground'},
                 {'period':1/3, 'amplitude':6, 'stimtype':'dotbackground'},

                 # classic frame: 5 speeds
                 {'period':1/3, 'amplitude':4, 'stimtype':'classicframe'},
                 {'period':1/1, 'amplitude':4, 'stimtype':'classicframe'},
                 {'period':1/2, 'amplitude':4, 'stimtype':'classicframe'},
                 ...
                 {'period':1/3, 'amplitude':1, 'stimtype':'classicframe'},
                 {'period':1/3, 'amplitude':2, 'stimtype':'classicframe'},
                 {'period':1/3, 'amplitude':3, 'stimtype':'classicframe'},
                 {'period':1/3, 'amplitude':5, 'stimtype':'classicframe'},
                 {'period':1/3, 'amplitude':6, 'stimtype':'classicframe'},

                 # dot counter frame: 1/3 speed only
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotcounterframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotcounterframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotcounterframe'},

                 # dot doubler  frame: 1/3 speed only
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotdoublerframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotdoublerframe'},
                 {'period':1/3, 'amplitude':4, 'stimtype':'dotdoublerframe'},

                 ]

        #return( dictToBlockTrials(cfg=cfg, condictionary=condictionary, nblocks=5, nrepetitions=2) )
        return( dictToBlockTrials(cfg=cfg, condictionary=condictionary, nblocks=3, nrepetitions=1) )
    ...
    if cfg['expno']==2:
        ...
        condictionary = [
                 ...
                 {'period':1/3, 'amplitude':3, 'stimtype':'dotbackground'},
                 {'period':1/1, 'amplitude':3, 'stimtype':'dotbackground'},
                 {'period':1/5, 'amplitude':3, 'stimtype':'dotbackground'},

                 {'period':1/3, 'amplitude':3, 'stimtype':'classicframe'},
                 {'period':1/1, 'amplitude':3, 'stimtype':'classicframe'},
                 {'period':1/5, 'amplitude':3, 'stimtype':'classicframe'},

                 {'period':1/3, 'amplitude':3, 'stimtype':'dotcounterframe'},

                 {'period':1/3, 'amplitude':3, 'stimtype':'dotdoublerframe'},
